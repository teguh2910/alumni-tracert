...
goog.exportSymbol('proto.proto.UserAnswerList', null, global);
/**
 ...
 * @constructor
 */
proto.proto.UserAnswerList = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.proto.UserAnswerList.repeatedFields_, null);
};
goog.inherits(proto.proto.UserAnswerList, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
 ...
 * @const
 */
proto.proto.UserAnswerList.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.proto.UserAnswerList.prototype.toObject = function(opt_includeInstance) {
  return proto.proto.UserAnswerList.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.proto.UserAnswerList} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.UserAnswerList.toObject = function(includeInstance, msg) {
  var f, obj = {
    answerList: jspb.Message.toObjectList(msg.getAnswerList(),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.proto.UserAnswerList}
 */
proto.proto.UserAnswerList.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.proto.UserAnswerList;
  return proto.proto.UserAnswerList.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.proto.UserAnswerList} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.proto.UserAnswerList}
 */
proto.proto.UserAnswerList.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.proto.UserAnswerList.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.proto.UserAnswerList.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.proto.UserAnswerList} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.UserAnswerList.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getAnswerList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
...
/**
 * repeated UserAnswer answer = 1;
 * @return {!Array<!proto.proto.UserAnswer>}
 */
proto.proto.UserAnswerList.prototype.getAnswerList = function() {
  return /** @type{!Array<!proto.proto.UserAnswer>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.proto.UserAnswer, 1));
};


/**
 * @param {!Array<!proto.proto.UserAnswer>} value
 * @return {!proto.proto.UserAnswerList} returns this
*/
proto.proto.UserAnswerList.prototype.setAnswerList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 * @return {!proto.proto.UserAnswer}
 */
proto.proto.UserAnswerList.prototype.addAnswer = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.proto.UserAnswer, opt_index);
};
 ...
 * @return {!proto.proto.UserAnswerList} returns this
 */
proto.proto.UserAnswerList.prototype.clearAnswerList = function() {
  return this.setAnswerList([]);
};
