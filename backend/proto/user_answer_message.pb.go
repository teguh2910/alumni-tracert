...
type UserAnswerList struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Answer []*UserAnswer `protobuf:"bytes,1,rep,name=answer,proto3" json:"answer,omitempty"`
}

func (x *UserAnswerList) Reset() {
	*x = UserAnswerList{}
	if protoimpl.UnsafeEnabled {
		mi := &file_user_answer_message_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *UserAnswerList) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserAnswerList) ProtoMessage() {}

func (x *UserAnswerList) ProtoReflect() protoreflect.Message {
	mi := &file_user_answer_message_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserAnswerList.ProtoReflect.Descriptor instead.
func (*UserAnswerList) Descriptor() ([]byte, []int) {
	return file_user_answer_message_proto_rawDescGZIP(), []int{5}
}

func (x *UserAnswerList) GetAnswer() []*UserAnswer {
	if x != nil {
		return x.Answer
	}
	return nil
...
var file_user_answer_message_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x77, 0x65, 0x72, 0x22, 0x3b, 0x0a, 0x0e, 0x55, 0x73, 0x65, 0x72, 0x41, 0x6e, 0x73,
	0x77, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x29, 0x0a, 0x06, 0x61, 0x6e, 0x73, 0x77, 0x65,
	0x72, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e,
	0x55, 0x73, 0x65, 0x72, 0x41, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x52, 0x06, 0x61, 0x6e, 0x73, 0x77,
	0x65, 0x72, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x3b, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06,
...
var file_user_answer_message_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_user_answer_message_proto_goTypes = []interface{}{
	...
	(*UserAnswerList)(nil),  // 5: proto.UserAnswerList
}
var file_user_answer_message_proto_depIdxs = []int32{
	...
	1, // 2: proto.UserAnswerList.answer:type_name -> proto.UserAnswer
...
func file_user_answer_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_user_answer_message_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UserAnswerList); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
